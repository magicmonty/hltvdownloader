#!/bin/sh
echo "deb http://ppa.launchpad.net/ermshiperete/monodevelop-beta/ubuntu precise main" > /etc/apt/sources.list.d/monodevelop-beta
...
apt-get update
apt-get install mono-devel mono-gmcs nunit-console monodevelop-current
